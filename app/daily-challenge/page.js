...
export default function DailyChallengePage() {
  ...
  function getShareMessage() {
    return `I solved Numble Daily (${puzzleId}) in ${guesses.length}/6 tries! Think you can beat me? ${window.location.origin}/daily-challenge`;
  }
  ...
  return (
    <>
      <div className="app">
        <h1>Numble Daily</h1>
        <p>Everyone gets the same 7-digit puzzle each UTC day</p>
